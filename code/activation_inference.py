...
from code.early_risk import compute_early_risk

# -------------------------
# PATHS
# -------------------------
ACT_PATH = os.path.join("data","split data", "activation_data.csv")
PREPROCESSOR_PATH = os.path.join("artifacts", "preprocessor.pkl")

OLS_PATH = os.path.join("documentation","Saved_models", "ols_model.pkl")
LOGREG_PATH = os.path.join("documentation","Saved_models", "logreg_model.pkl")
RF_PATH = os.path.join("documentation","Saved_models", "rf_model.pkl")
ANN_PATH = os.path.join("documentation","Saved_models", "ann_models.h5")
