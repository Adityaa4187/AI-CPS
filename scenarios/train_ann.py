...
from code.plots import plot_confusion_matrix, plot_roc_curve, plot_pr_curve

MODEL_DIR = os.path.join("documentation", "Saved_models")
PLOT_DIR = os.path.join("reports", "model_plots", "ann")

os.makedirs(MODEL_DIR, exist_ok=True)
os.makedirs(PLOT_DIR, exist_ok=True)

MODEL_PATH = os.path.join(MODEL_DIR, "ann_models.h5")
